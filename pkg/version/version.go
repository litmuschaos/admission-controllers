...
const (
	versionFile   string = "/src/github.com/litmuschaos/admission-controllers/VERSION"
	buildMetaFile string = "/src/github.com/litmuschaos/admission-controllers/BUILDMETA"
